...
export class Provider {
   ...
   */
  static from_state(bytes: Uint8Array): Provider;
  constructor();
}
...
export interface InitOutput {
  ...
  readonly group_merge_pending_commit: (
    a: number,
    b: number,
  ) => [number, number];
  readonly group_process_message: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => [number, number, number, number];
  readonly group_propose_and_commit_add: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => [number, number, number];
  readonly group_propose_and_commit_remove: (
    a: number,
    b: number,
    c: number,
    d: number,
