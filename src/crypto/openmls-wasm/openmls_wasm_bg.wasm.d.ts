...
export const group_load: (
  a: number,
  b: number,
  c: number,
) => [number, number, number];
export const group_merge_pending_commit: (
  a: number,
  b: number,
) => [number, number];
export const group_process_message: (
  a: number,
  b: number,
  c: number,
  d: number,
) => [number, number, number, number];
export const group_propose_and_commit_add: (
  a: number,
  b: number,
  c: number,
  d: number,
) => [number, number, number];
export const group_propose_and_commit_remove: (
  a: number,
  b: number,
  c: number,
  d: number,
